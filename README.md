...
| [cdk-iot-amazing-hand-streaming](https://github.com/chiwaichan/cdk-iot-amazing-hand-streaming) | **IoT-to-AppSync Infrastructure (this repo)** — AWS CDK stack that routes robotic hand state data from AWS IoT Core through Lambda to AppSync, enabling real-time GraphQL subscriptions for clients | [Read blog](https://www.chiwaichan.co.nz/blog/2026/03/14/voice-to-sign-language-cloud-infrastructure-iot-appsync-cdk) |
